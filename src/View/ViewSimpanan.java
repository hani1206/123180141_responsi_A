...
public class ViewSimpanan extends JFrame{
    ...
    JLabel title2 = new JLabel("PERPUSTAKAAN");
    JLabel title3 = new JLabel("JIKA INGIN MENGHAPUS DATA KLIK LANGSUNG PADA TABEL!!");
    ...
    public Object[] namaKolom = {"ID", "Id_Anggota","Nama","Id_Buku","Judul"};
    ...
    public ViewSimpanan(){
        ...
        add(title2);
        title2.setBounds(340,100,800,50);
        title2.setFont(new Font("Garamond",Font.BOLD,45));
        title2.setForeground(peach);

        add(title3);
        title3.setBounds(340,150,800,50);
        title3.setFont(new Font("Garamond",Font.BOLD,10));
        title3.setForeground(red);

        add(jScrollPane);
        jScrollPane.setBounds(100,200,1000,400);
